...
public class DateEx {
	...
	public static void main(String[] args) throws ParseException {
		...
		//Date.getTime();
		//: 1970년 1월 1일 0시 0분 0초 ms 부터 Date에 지정된 날짜/시간 까지의 ms 누적값
		...
		//Date 객체의 getXXX() 메소드는 deprecated (더이상 사용 권장 안함
		//--> 날짜의 년/월/일을 추출하는 기능은 Calendar 클래스에서 주로 사용
		System.out.println("Today (/년) : " + date1.getYear());
		System.out.println("Today (/월) : " + date1.getYear());
		System.out.println("Today (/일) : " + date1.getYear());
		...
		int dayTime = (1000 * 60 * 60 * 24);		//ms 단위로 1일로 환산한 값
