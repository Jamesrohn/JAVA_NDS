...
public class Jiwoo {
	...
	public static void main(String[] args) {
		...
		System.out.println("공격 A : " + pikachu.aAttak());
		System.out.println("공격 B : " + pikachu.bAttak());
		System.out.println();
		...
		System.out.println("공격 A : " + pikachu20.aAttak());
		System.out.println("공격 B : " + pikachu20.bAttak());
		System.out.println();
		...
		System.out.println("공격 A : " + raichu.aAttak());
		System.out.println("공격 B : " + raichu.bAttak());
		...
		System.out.println("공격 A : " + raichu40.aAttak());
		System.out.println("공격 B : " + raichu40.bAttak());
